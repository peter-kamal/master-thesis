...
Perfect. I'll clean the data up a little, and then I will save it, disaggregated by land use zone. This is necessary due to memory restrictions in the GEE API.
...
From here, these are individually ingested in the GEE JavaScript API, and exported as GEOJSONs using the script 'satellite-raw-export.js'.
